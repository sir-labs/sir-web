  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col relative overflow-hidden w-[440px] xl:w-[500px] shrink-0"
        ...
        <div className="relative z-10 mt-auto px-12 pb-10">
          ...
          <p className="text-white/60 text-[0.9375rem] leading-relaxed mb-10 max-w-[280px]">
            Write, compile, and export beautifully typeset documents with LuaLaTeX in seconds.
          </p>

          {/* Feature list */}
          <div className="flex flex-col gap-3">
            {[
              { label: 'Real-time LuaLaTeX compilation' },
              { label: 'PDF export & file management' },
              { label: 'Encrypted OAuth authentication' },
            ].map(f => (
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
        ...
        {/* Orbs on mobile only */}
        <div className="lg:hidden ambient-orb bg-indigo-500/15 w-96 h-96 -top-20 -right-20" style={{ animationDelay: '0s' }} />
        <div className="lg:hidden ambient-orb bg-violet-500/12 w-80 h-80 bottom-0 -left-16" style={{ animationDelay: '-4s' }} />
        ...
        <div className="relative z-10 w-full max-w-[360px] fade-up">
          ...
          <p className="mt-10 text-center text-slate-400 text-xs">
            Sir. Platform v2.0 · All connections encrypted
          </p>
        </div>
      </div>
    </div>
